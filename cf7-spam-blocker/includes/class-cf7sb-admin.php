				...
				<table class="form-table" role="presentation">
					...
					<tr>
						...
						<td>
							...
							<p class="description">
								判定は2段構えです。「相互リンク」「リンク交換」「紹介し合う」「コンテンツ連携」等の<strong>依頼の核心語（強シグナル・+2点）が含まれない送信は、何点でもブロックしません</strong>。核心語がある場合のみ、リンク設置の言い回し・本文中のURL・「突然のご連絡」等の営業定型句・DRやSEO等の用語・無償オファー・「サイト運営ご担当者様」等の宛名（各+1点）を加算し、<strong>合計3点以上</strong>で拒否します。<br>
